...
const City = require('../../models/weather/city');
const Weather = require('../../models/weather/weather');
const SunriseAndSunset = require('../../models/weather/sunrise-and-sunset');
const Wind = require('../../models/weather/wind');
const CityWeather = require('../../models/weather/city-weather');
