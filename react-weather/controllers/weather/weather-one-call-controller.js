...
const HourlyWeatherList = require('../../models/weather/hourly-weather-list');
const DailyWeatherList = require('../../models/weather/daily-weather-list');
const Forecast = require('../../models/weather/forecast');
